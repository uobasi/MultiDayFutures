...
def update_graph_live(n_intervals, sname, stored_data, interval_time, previous_stkName): #,previous_stkName
    ...
    fig.add_trace(go.Scatter(x=pd.Series([i for i in range(len(df))]), y=df['STDEV_2Cum'].cumsum() / (df.index + 1), mode='lines', opacity=0.8, name='UPPERVWAP2', line=dict(color='black')))
    fig.add_trace(go.Scatter(x=pd.Series([i for i in range(len(df))]), y=df['STDEV_N2Cum'].cumsum() / (df.index + 1), mode='lines', opacity=0.8, name='LOWERVWAP2', line=dict(color='black')))

    fig.add_trace(go.Scatter(x=pd.Series([i for i in range(len(df))]), y=df['STDEV_25Cum'].cumsum() / (df.index + 1), mode='lines', opacity=0.8, name='UPPERVWAP2.5', line=dict(color='black')))
    fig.add_trace(go.Scatter(x=pd.Series([i for i in range(len(df))]), y=df['STDEV_N25Cum'].cumsum() / (df.index + 1), mode='lines', opacity=0.8, name='LOWERVWAP2.5', line=dict(color='black')))
   
    fig.add_trace(go.Scatter(x=pd.Series([i for i in range(len(df))]), y=df['STDEV_1Cum'].cumsum() / (df.index + 1), mode='lines', opacity=0.8, name='UPPERVWAP1', line=dict(color='black')))
    fig.add_trace(go.Scatter(x=pd.Series([i for i in range(len(df))]), y=df['STDEV_N1Cum'].cumsum() / (df.index + 1), mode='lines', opacity=0.8, name='LOWERVWAP1', line=dict(color='black')))
            
    fig.add_trace(go.Scatter(x=pd.Series([i for i in range(len(df))]), y=df['STDEV_15Cum'].cumsum() / (df.index + 1), mode='lines', opacity=0.8, name='UPPERVWAP1.5', line=dict(color='black')))
    fig.add_trace(go.Scatter(x=pd.Series([i for i in range(len(df))]), y=df['STDEV_N15Cum'].cumsum() / (df.index + 1), mode='lines', opacity=0.8, name='LOWERVWAP1.5', line=dict(color='black')))

    fig.add_trace(go.Scatter(x=pd.Series([i for i in range(len(df))]), y=df['STDEV_0Cum'].cumsum() / (df.index + 1), mode='lines', opacity=0.8, name='UPPERVWAP0.5', line=dict(color='black')))
    fig.add_trace(go.Scatter(x=pd.Series([i for i in range(len(df))]), y=df['STDEV_N0Cum'].cumsum() / (df.index + 1), mode='lines', opacity=0.8, name='LOWERVWAP0.5', line=dict(color='black')))


    fig.add_trace(go.Scatter(x=pd.Series([i for i in range(len(df))]), y=df['STDEV_075Cum'].cumsum() / (df.index + 1), mode='lines', opacity=0.8, name='UPPERVWAP0.75', line=dict(color='black')))
    fig.add_trace(go.Scatter(x=pd.Series([i for i in range(len(df))]), y=df['STDEV_N075Cum'].cumsum() / (df.index + 1), mode='lines', opacity=0.8, name='LOWERVWAP0.75', line=dict(color='black')))
            
    fig.add_trace(go.Scatter(x=pd.Series([i for i in range(len(df))]), y=df['STDEV_125Cum'].cumsum() / (df.index + 1), mode='lines', opacity=0.8, name='UPPERVWAP1.25', line=dict(color='black')))
    fig.add_trace(go.Scatter(x=pd.Series([i for i in range(len(df))]), y=df['STDEV_N125Cum'].cumsum() / (df.index + 1), mode='lines', opacity=0.8, name='LOWERVWAP1.25', line=dict(color='black')))

    fig.add_trace(go.Scatter(x=pd.Series([i for i in range(len(df))]), y=df['STDEV_175Cum'].cumsum() / (df.index + 1), mode='lines', opacity=0.8, name='UPPERVWAP1.75', line=dict(color='black')))
    fig.add_trace(go.Scatter(x=pd.Series([i for i in range(len(df))]), y=df['STDEV_N175Cum'].cumsum() / (df.index + 1), mode='lines', opacity=0.8, name='LOWERVWAP1.75', line=dict(color='black')))

    fig.add_trace(go.Scatter(x=pd.Series([i for i in range(len(df))]), y=df['STDEV_225Cum'].cumsum() / (df.index + 1), mode='lines', opacity=0.8, name='UPPERVWAP2.25', line=dict(color='black')))
    fig.add_trace(go.Scatter(x=pd.Series([i for i in range(len(df))]), y=df['STDEV_N225Cum'].cumsum() / (df.index + 1), mode='lines', opacity=0.8, name='LOWERVWAP2.25', line=dict(color='black')))

    fig.add_trace(go.Scatter(x=pd.Series([i for i in range(len(df))]), y=df['STDEV_025Cum'].cumsum() / (df.index + 1), mode='lines', opacity=0.8, name='UPPERVWAP0.25', line=dict(color='black')))
    fig.add_trace(go.Scatter(x=pd.Series([i for i in range(len(df))]), y=df['STDEV_N025Cum'].cumsum() / (df.index + 1), mode='lines', opacity=0.8, name='LOWERVWAP0.25', line=dict(color='black')))
    ...
    fig.add_trace(go.Scatter(x=pd.Series([i for i in range(len(df))]), y=df['prevDayPOC'].cumsum() / (df.index + 1), mode='lines', name='prevDayPOC', opacity=0.8, line=dict(color='orange')))
    fig.add_trace(go.Scatter(x=pd.Series([i for i in range(len(df))]), y=df['prevDayHVA'].cumsum() / (df.index + 1), mode='lines', name='prevDayHVA', opacity=0.8, line=dict(color='green')))   
    fig.add_trace(go.Scatter(x=pd.Series([i for i in range(len(df))]), y=df['prevDayLVA'].cumsum() / (df.index + 1), mode='lines', name='prevDayLVA', opacity=0.8, line=dict(color='purple'))) 
